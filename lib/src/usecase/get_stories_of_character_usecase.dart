...
class GetStoriesOfCharacterUseCase {
  final CharactersRemote _charactersRemote;

  GetStoriesOfCharacterUseCase(this._charactersRemote);
  ...
  Future<ResultadoState> execute(String characterId) {
    ...
    return _charactersRemote.getStoriesOfCharacter(request, characterId);
  }
}
